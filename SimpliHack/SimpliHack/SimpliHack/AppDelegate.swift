...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func activatingUserLocalNotification()
    {
        /* Enable local notifications */
        
        localNotifications  = UILocalNotification()
        localNotifications.fireDate = NSDate(timeIntervalSinceNow: 60) // 30 days -  30*24*60*60
        localNotifications.repeatInterval = NSCalendarUnit.MonthCalendarUnit
        localNotifications.timeZone = NSTimeZone.defaultTimeZone()
        localNotifications.alertBody = "Hey buddy, come back. We glad that you rested for sometime"
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.olacabs.SimpliHack" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SimpliHack", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("SimpliHack.sqlite")
